...
namespace ElectronicGradeBook.Controllers
{
    ...
    public class StudentActivitiesController : Controller
    {
        ...
        public StudentActivitiesController(IStudentActivityService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Add([FromBody] StudentActivityViewModel model)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit([FromBody] StudentActivityViewModel model)
        {
            try
            {
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                return Json(new { success = true, message = "Запис студентської активності видалено." });
            }
            catch (Exception ex)
            {
                return Json(new { success = false, message = ex.Message });
