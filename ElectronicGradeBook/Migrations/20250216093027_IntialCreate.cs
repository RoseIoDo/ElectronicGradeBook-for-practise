        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Specialties_StudyPrograms_ProgramId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SemesterInYear = table.Column<int>(type: "int", nullable: false),
                    AcademicYear = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Credits = table.Column<decimal>(type: "decimal(4,1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupPrefix = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubjectSubgroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubjectSubgroups_SubjectOfferings_SubjectOfferingId",
                        column: x => x.SubjectOfferingId,
                        principalTable: "SubjectOfferings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubjectSubgroups_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubjectOfferingGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubjectOfferingGroups_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SubjectOfferingGroups_SubjectOfferings_SubjectOfferingId",
                        column: x => x.SubjectOfferingId,
                        principalTable: "SubjectOfferings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradeVersionJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Grades_SubjectOfferings_SubjectOfferingId",
                        column: x => x.SubjectOfferingId,
                        principalTable: "SubjectOfferings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentPrivileges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentPrivileges_Privileges_PrivilegeId",
                        column: x => x.PrivilegeId,
                        principalTable: "Privileges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentPrivileges_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "SubjectSubgroupStudents",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SubjectSubgroupId = table.Column<int>(type: "int", nullable: false),
                    StudentId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubjectSubgroupStudents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubjectSubgroupStudents_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubjectSubgroupStudents_SubjectSubgroups_SubjectSubgroupId",
                        column: x => x.SubjectSubgroupId,
                        principalTable: "SubjectSubgroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Grades_SubjectOfferingId",
                table: "Grades",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentPrivileges_PrivilegeId",
                table: "StudentPrivileges",
                column: "PrivilegeId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentPrivileges_StudentId",
                table: "StudentPrivileges",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubjectOfferingGroups_GroupId",
                table: "SubjectOfferingGroups",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_SubjectOfferingGroups_SubjectOfferingId",
                table: "SubjectOfferingGroups",
                column: "SubjectOfferingId");

            migrationBuilder.CreateIndex(
                name: "IX_SubjectOfferings_SubjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubjectSubgroups_SubjectOfferingId",
                table: "SubjectSubgroups",
                column: "SubjectOfferingId");

            migrationBuilder.CreateIndex(
                name: "IX_SubjectSubgroups_TeacherId",
                table: "SubjectSubgroups",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_SubjectSubgroupStudents_StudentId",
                table: "SubjectSubgroupStudents",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_SubjectSubgroupStudents_SubjectSubgroupId",
                table: "SubjectSubgroupStudents",
